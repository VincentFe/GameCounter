 ...
 * @returns {void}
 */
export function renderEnterNames(res, baseDir, initialPlayers) {
 ...
 */
export async function saveName(req, res, baseDir) {
    try {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function setGameName(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const name = (parsed.name || "").toString().trim();
        if (!name) {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function setGameType(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function deletePlayer(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const name = (parsed.name || "").toString().trim();
        if (!name) {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function removeAllPlayers(req, res, baseDir) {
    try {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function updatePlayerScore(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const name = (parsed.name || "").toString().trim();
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function setPlayerScore(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const name = (parsed.name || "").toString().trim();
        const score = typeof parsed.score === "number" ? parsed.score : undefined;
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function reorderPlayers(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function saveGameInstance(req, res, baseDir) {
    try {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function addPlayer(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const name = (parsed.name || "").toString().trim();
        if (!name) {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function markGameInactive(req, res, baseDir) {
    try {
 ...
 * @returns {Promise<void>} Resolves when response is sent.
 */
export async function setRound(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
 ...
 * Body: { names: string[] }
 */
export async function resetPlayersForNewGame(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
        const names = Array.isArray(parsed.names) ? parsed.names.map((n) => String(n || "").trim()) : [];
 ...
 * Body: { count: number }
 */
export async function createGroups(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
 ...
 */
export async function setGroupName(req, res, baseDir) {
    try {
        const parsed = await readJsonBody(req);
 ...
 */
export async function startGameWithGroups(req, res, baseDir) {
    try {
