...
import { getSessionId, requireAuth, requireGrandmaster } from "./middleware/auth.js";
...
function createRequestListener() {
    return async (req, res) => {
        ...
        // Handle auth routes
        if (handleAuthRoutes(req, res, method, pathname))
            return;
        // Require auth for all other routes
        if (!requireAuth(req, res))
            return;
        // Handle game routes
        if (handleGameRoutes(req, res, method, url, pathname, getQueryParam, appDir))
            return;
        // Handle static files
 ...
 */
function handleAuthRoutes(req, res, method, pathname) {
 ...
 * @returns {boolean} True if handled
 */
function handleGameRoutes(req, res, method, url, pathname, getQueryParam, appDir) {
