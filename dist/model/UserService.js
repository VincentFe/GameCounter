 ...
 */
async function loadUsers(baseDir) {
    if (usersLoaded)
        return;
 ...
 * @param {string} baseDir - The base directory.
 */
async function saveUsers(baseDir) {
    const usersFile = path.join(baseDir, "..", "db", "users.json");
 ...
 */
export async function authenticate(baseDir, username, password) {
 ...
 */
export function isGrandmaster(user) {
 ...
 */
export async function createUser(baseDir, username, password, isGrandmaster = false) {
    await loadUsers(baseDir);
