 ...
 * @returns {Promise<{ ok: boolean; error?: string }>} Success status and optional error message.
 */
export declare function reorderPlayers(baseDir: string, newOrder: string[]): Promise<{
    ok: boolean;
    error: string;
} | {
    ok: boolean;
 ...
 */
export declare function createGroups(baseDir: string, count: number): Promise<{
    ok: boolean;
    error: string;
    groups?: undefined;
} | {
 ...
 */
export declare function startGameWithGroups(baseDir: string): Promise<{
    ok: boolean;
    error: string;
} | {
    ok: boolean;
 ...
 */
export declare function getGroups(): any[];
/**
 * Set a group's name by id.
 */
export declare function setGroupName(baseDir: string, groupId: string, name: string): Promise<{
    ok: boolean;
    error: string;
} | {
    ok: boolean;
 ...
 * @param {string[]} names
 */
export declare function resetPlayersForNewGame(baseDir: string, names: string[]): Promise<{
    ok: boolean;
}>;
declare const _default: {
    ...
    reorderPlayers: typeof reorderPlayers;
    ...
    resetPlayersForNewGame: typeof resetPlayersForNewGame;
};
